...
<head>
    ...
    <script src="<c:url value="/resources/js/main2.js"/>" defer></script>
    ...
    <section id="main">
        <div class="main-map">
            <a class="dogicon" style="height: 150px; z-index: 2"><img src="<c:url value="/resources/image/dogicon.png"/>"></a>
            <br><br>
            ...
            <div class="main-side">
                <div class="main-pin">
                    <a href="#" onclick="pin1()"><img src="<c:url value="/resources/image/pin1.png"/>" alt="핀1"></a>
                    <a href="#"><img src="<c:url value="/resources/image/pin2.png"/>" alt="핀2"></a>
                    <a href="#"><img src="<c:url value="/resources/image/pin3.png"/>" alt="핀3"></a>
                    <a href="#"><img src="<c:url value="/resources/image/pin4.png"/>" alt="핀4"></a>
                    <a href="#"><img src="<c:url value="/resources/image/pin5.png"/>" alt="핀5"></a>
                    <a href="#"><img src="<c:url value="/resources/image/pin6.png"/>" alt="핀6"></a>
                </div>
            </div>
        </div>
    ...
    <article class="main-about">
        <div class="main-btn" width="80%" height="auto">
            <button type="button" id="main-btn" name="petsitter"><a href="<c:url value="/danguen"/>">댕근마켓 바로가기▶</a></button>
            <button type="button" id="main-btn-" name="pet"><a href="<c:url value="/dangcare"/>">댕댕케어 바로가기▶</a></button>
        </div>
        <br>
    </article>
    <br><br>
    <footer class="main-about">
        <img src="<c:url value="/resources/image/about.png"/>" width="90%" height="auto">
    </footer>
    <br><br><br><br>
    </body>
</html>